# Guide for installing, setting up and building Zephyr hifi5s_4c_l2 config
...
export XTENSA_CORE='hifi5s_4c_l2'
...
git checkout foss-xtensa/hifi5s_4c_l2 -b hifi5s_4c_l2
west update
```
