...
#define XCHAL_SUBSYS_IPI_S0C0_INTNUM 24
#define XCHAL_SUBSYS_IPI_S0C1_INTNUM 25
#define XCHAL_SUBSYS_IPI_S0C2_INTNUM 26
#define XCHAL_SUBSYS_IPI_S0C3_INTNUM 27
...
{
	unsigned int curr = arch_proc_id();
